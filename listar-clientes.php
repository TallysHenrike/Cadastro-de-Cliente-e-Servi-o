...
$PageSql = "SELECT * FROM `cadastroCliente`";
...
if ($a == "buscar") {
    ...
    $ReadSql = "SELECT * FROM `cadastroCliente` WHERE `nome` LIKE '%$busca%' AND `funcionario` LIKE '%$funcionario%' ORDER BY id DESC LIMIT $start, $perpage ";
}else{
    $ReadSql = "SELECT * FROM `cadastroCliente` WHERE `funcionario` LIKE '%$funcionario%' ORDER BY id DESC LIMIT $start, $perpage ";
}
...
<html>
    <head>
        ...
        <title>Lê Santê - Tabela de Cliente</title>
        <link rel="icon" href="">
            ...
            <table id="tabela" class="table table-striped table-bordered table-dark">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo utf8_encode($r['telefone']); ?></td>
                        <td><?php echo utf8_encode($r['endereco']); ?></td>
                        <td><?php echo utf8_encode($r['funcionario']); ?></td>
                        <td><?php echo date("d-m-Y H:i:s", strtotime($r['data_cadastro'])); ?></td>
                        <td>
                            <a href="update-cliente.php?id=<?php echo $r['id']; ?>" class="btn btn-info btn-sm">Editar</a>
                                ...
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="delete-cliente.php?id=<?php echo $r['id']; ?>" class="btn btn-danger">Apagar</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
